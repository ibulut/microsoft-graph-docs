...
|:---|:---|:---|
|allowedAudiences|String|The audiences that are able to see the values contained within the entity. Inherited from [itemFacet](../resources/itemfacet.md). Possible values are: `me`, `organization`, `federatedOrganization`, `everyone`, `unknownFutureValue`.|
